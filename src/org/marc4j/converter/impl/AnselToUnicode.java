...
public class AnselToUnicode extends CharConverter {
    ...
    private String convertMultibyte(CodeTracker cdt, char[] data) {
        ...
        while (offset < data.length && data[offset] != 0x1b) {
            ...
            if (data[offset] == 0x20) {
            ...
            } else if (errorsPresent == false && offset + 3 <= data.length && (curReader == null || data[offset + 1] != 0x20 && data[offset + 2] != 0x20)
                ...
                if (curReader == null || c != 0) {
                    ...
                    && (getMBChar(makeMultibyte(data[offset + 0], data[offset + 1], data[offset + 2])) == 0 || getMBChar(makeMultibyte(data[offset + 3], data[offset + 4],
                            data[offset + 5])) == 0) && getMBChar(makeMultibyte(data[offset + 2], data[offset + 3], data[offset + 4])) != 0
                    && noneEquals(data, offset, offset + 5, 0x1b) && noneInRange(data, offset, offset + 5, 0x80, 0xFF) && !nextEscIsMB(data, offset, data.length)) {
                String mbstr = getMBCharStr(makeMultibyte(data[offset], '[', data[offset + 1])) + getMBCharStr(makeMultibyte(data[offset], ']', data[offset + 1]))
                        + getMBCharStr(makeMultibyte(data[offset], data[offset + 1], '[')) + getMBCharStr(makeMultibyte(data[offset], data[offset + 1], ']'));
                if (mbstr.length() == 1) {
                    if (curReader != null)
                        curReader.addError(MarcError.MINOR_ERROR, "Missing square brace character in MARC8 multibyte character, inserting one to create the only valid option");
                    sb.append(mbstr);
                    offset += 2;
                    ...
                    if (curReader != null)
                        curReader.addError(MarcError.MINOR_ERROR, "Erroneous MARC8 multibyte character, Discarding bad character and continuing reading Multibyte characters");
                    sb.append("[?]");
                    offset += 2;
                }
                    ...
                    && noneEquals(data, offset, offset + 3, ' ')
                    && (getMBChar(makeMultibyte(data[offset + 0], data[offset + 1], data[offset + 2])) == 0 || getMBChar(makeMultibyte(data[offset + 3], data[offset + 4],
                            data[offset + 5])) == 0) && getMBChar(makeMultibyte(data[offset + 4], data[offset + 5], data[offset + 6])) != 0
                    && noneEquals(data, offset, offset + 6, 0x1b) && noneInRange(data, offset, offset + 6, 0x80, 0xFF) && !nextEscIsMB(data, offset, data.length)) {
                String mbstr = getMBCharStr(makeMultibyte(data[offset], '[', data[offset + 1])) + getMBCharStr(makeMultibyte(data[offset], ']', data[offset + 1]))
                        + getMBCharStr(makeMultibyte(data[offset], data[offset + 1], '[')) + getMBCharStr(makeMultibyte(data[offset], data[offset + 1], ']'));
                if (mbstr.length() == 1) {
                    if (curReader != null)
            ...
            } else if (offset + 4 <= data.length && data[offset] > 0x7f && getMBChar(makeMultibyte(data[offset + 1], data[offset + 2], data[offset + 3])) != 0) {
                if (curReader != null) {
                    curReader
                            .addError(MarcError.MINOR_ERROR, "Erroneous character in MARC8 multibyte character, Copying bad character and continuing reading Multibyte characters");
